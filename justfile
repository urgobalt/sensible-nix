...
switch path=default_configuration_path *args="":
    {{ builder }} switch {{ path }} -- {{ override_input }} {{ args }}

[group("install")]
boot path=default_configuration_path *args="":
    {{ builder }} boot {{ path }} -- {{ override_input }} {{ args }}

[group("install")]
dry path=default_configuration_path *args="":
    {{ builder }} switch {{ path }} -n -- {{ override_input }} {{ args }}

[group("development")]
check path=default_configuration_path *args="-L --debugger":
    nix flake check {{ path }} {{ override_input }} {{ args }}
